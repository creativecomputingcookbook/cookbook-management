  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto px-4">
        ...
        {claims?.admin &&
          <div className="bg-white rounded-lg shadow-sm border p-8 m-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-6">Miscellaneous</h1>
            <Link 
              href="/tags"
              className="inline-flex items-center px-4 py-2 mx-2 border border-transparent text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors"
            >
              Manage Tags
            </Link>
            <Link 
